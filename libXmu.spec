...
Source0  : https://www.x.org/releases/individual/lib/libXmu-1.2.1.tar.gz
Source1  : https://www.x.org/releases/individual/lib/libXmu-1.2.1.tar.gz.sig
...
%setup -q -n libXmu-1.2.1
cd %{_builddir}/libXmu-1.2.1
pushd ..
cp -a libXmu-1.2.1 build32
popd
pushd ..
cp -a libXmu-1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713373367
